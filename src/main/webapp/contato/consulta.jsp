...
<script type="text/javascript">
	...
	<div class="container">
		<div class="jumbotron">
			<h2>
				Memori<i class="glyphicon glyphicon-phone"></i>m</h2>
			...
			<table class="table table-striped">
				...
				<c:forEach var="contato" items="${contatos}">
					<tr align="left">
						<td><span class="fake_check glyphicon glyphicon-unchecked"><input
										hidden class="selections" name="del_selected" type="checkbox"
										value="${contato.id}" /></span></td>
			...
			<a href="contato/cadastro.jsp" class="form-control btn btn-primary"
					style="width: 350px;">Novo Contato <i
					class="glyphicon glyphicon-floppy-disk"></i></a><br> 
			...
			<a class="form-control btn btn-danger btn_delete"
					style="display: none; width: 350px">Apagar selecionados <i
